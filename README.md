...
Rutas abogado: `/abogado` (bandeja), `/abogado/fase2/admin` (Escritorio), `/abogado/fase2/templates`, `/abogado/fase2/ai`, `/abogado/fase2/billing` (Facturación B2B). `/fase2/admin` redirige a Escritorio.
