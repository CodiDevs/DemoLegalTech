...
export const PRODUCT_SITES: Record<string, ProductSiteConfig> = {
  traslado360: {
    ...
    workflow: [
      { n: 1, title: 'Cuestionario', desc: 'Datos del vehículo y acuerdo entre partes.', screen: 'Intake' },
      { n: 2, title: 'Pago único', desc: 'Honorario mock sin suscripción mensual.', screen: 'Checkout' },
      { n: 3, title: 'Documentos', desc: 'Matrícula y acuerdo de traslado.', screen: 'Upload' },
    ...
    gallery: [
      ...
      { id: '02', title: 'Pago único mock', category: 'Checkout', src: 'https://images.unsplash.com/photo-1563013544-824ae1b704d3?auto=format&fit=crop&w=900&q=80', alt: 'Pago trámite' },
  ...
  bienraiz360: {
    ...
    workflow: [
      { n: 1, title: 'Cuestionario', desc: 'Datos del inmueble y partes de acuerdo.', screen: 'Intake' },
      { n: 2, title: 'Pago único', desc: 'Honorario mock sin plan mensual.', screen: 'Checkout' },
      { n: 3, title: 'Documentos', desc: 'Título y acuerdo mutuo de traslado.', screen: 'Upload' },
      { n: 4, title: 'Consulta', desc: 'Revisión jurídica por videollamada.', screen: 'Consulta' },
      { n: 5, title: 'Firma', desc: 'Escritura mock y firma electrónica.', screen: 'Firma' },
      { n: 6, title: 'Notaría', desc: 'Reunión virtual y registro demo.', screen: 'Notaría' },
    ],
    stats: [
      ...
      { label: 'Comparecencia', value: 'Virtual', detail: 'Notario en videollamada mock.', icon: 'building' },
    ],
    gallery: [
